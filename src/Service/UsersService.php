...
final class UsersService extends Service
{
    ...
    {
        $count = $this->executeQuery(
            'admin/realms/'.$realm.'/users/'.$userId.'/groups/count',
            'array',
        );
        if (null === $count) {
            return 0;
     ...
     * @return RoleCollection<RoleRepresentation>|null
     */
    public function availableRealmRoles(
        string $realm,
        string $userId,
    ): ?RoleCollection {
        return $this->executeQuery(
    ...
    public function removeRealmRole(
        string $realm,
        string $userId,
        RoleRepresentation $role,
    ): bool {
     ...
     * @return RoleCollection<RoleRepresentation>|null
     */
    public function availableClientRoles(
        string $realm,
        string $clientUuid,
        string $userId,
    ): ?RoleCollection {
    ...
    public function removeClientRole(
        string $realm,
        string $clientUuid,
        string $userId,
        RoleRepresentation $role,
