...
class UsersServiceTest extends TestCase
{
    ...
    public function testAllWithCriteria(): void
    {
        ...
        $this->httpClient
            ...
            ->with(
                'GET',
                'admin/realms/'.$realm.'/users?briefRepresentation=true',
                m::type('array'),
            )
            ->andReturn($response);
    ...
    public function testGet(): void
    {
        ...
        $userId = 'user1';
        $responseBody =
            '{"id":"user1","username":"user1","firstName":"John","lastName":"Doe"}';
        $stream = $this->createMock(StreamInterface::class);
        $stream->method('getContents')->willReturn($responseBody);
    ...
    public function testSessions(): void
    {
        ...
        $userId = 'user1';
        $responseBody =
            '[{"id":"session1","userId":"user1"},{"id":"session2","userId":"user1"}]';
        $stream = $this->createMock(StreamInterface::class);
        $stream->method('getContents')->willReturn($responseBody);
    ...
    public function testOfflineSessions(): void
    {
        ...
        // when
        $result = $this->usersService->offlineSessions(
            $realm,
            $userId,
            $clientId,
        );
    ...
    public function testClientRoles(): void
    {
        ...
        // when
        $result = $this->usersService->clientRoles(
            $realm,
            $clientUuid,
            $userId,
        );
    ...
    public function testAvailableClientRoles(): void
    {
        ...
        // when
        $result = $this->usersService->availableClientRoles(
            $realm,
            $clientUuid,
            $userId,
        );
    ...
    public function testAddClientRole(): void
    {
        ...
        // when
        $result = $this->usersService->addClientRole(
            $realm,
            $clientUuid,
            $userId,
            $role,
    ...
    public function testRemoveClientRole(): void
    {
        ...
        // when
        $result = $this->usersService->removeClientRole(
            $realm,
            $clientUuid,
            $userId,
            $role,
    ...
    public function testGetProfileConfig(): void
    {
        ...
        $realm = 'test-realm';
        $responseBody =
            '{"attributes":[{"name":"firstName","displayName":"First name"}]}';
        $stream = $this->createMock(StreamInterface::class);
        $stream->method('getContents')->willReturn($responseBody);
    ...
    public function testGetProfileMetadata(): void
    {
        ...
        $realm = 'test-realm';
        $responseBody =
            '{"userProfileAttributeMetadata":[{"name":"firstName","displayName":"First name"}]}';
        $stream = $this->createMock(StreamInterface::class);
        $stream->method('getContents')->willReturn($responseBody);
    ...
    public function testSendVerifyEmail(): void
    {
        ...
        // when
        $result = $this->usersService->sendVerifyEmail(
            $realm,
            $userId,
            $parameters,
        );
